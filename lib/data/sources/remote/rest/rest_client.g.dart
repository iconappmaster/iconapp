...
class _RestClient implements RestClient {
  ...
  @override
  Future<dynamic> requestToJoinConversation(conversationId) async {
    ArgumentError.checkNotNull(conversationId, 'conversationId');
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _data = <String, dynamic>{};
    final _result = await _dio.request(
        'conversations/$conversationId/request_to_join_conversation',
        queryParameters: queryParameters,
        options: RequestOptions(
            method: 'POST',
            headers: <String, dynamic>{},
  ...
  Future<Conversation> acceptRequestToJoinConversation(
    ...
    final _data = <String, dynamic>{};
    final _result = await _dio.request<Map<String, dynamic>>(
        'conversations/$conversationId/accept_request_to_join_conversation',
        queryParameters: queryParameters,
        options: RequestOptions(
            method: 'POST',
            headers: <String, dynamic>{},
  ...
  Future<List<RedemptionActionModel>> userCreditAction() async {
    ...
    final queryParameters = <String, dynamic>{};
    final _data = <String, dynamic>{};
    final _result = await _dio.request<List<dynamic>>('user_credit_actions',
        queryParameters: queryParameters,
        options: RequestOptions(
            method: 'GET',
            headers: <String, dynamic>{},
  ...
  @override
  Future<dynamic> creditAction(creditActionId) async {
    ArgumentError.checkNotNull(creditActionId, 'creditActionId');
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{
      r'creditActionId': creditActionId
    };
    final _data = <String, dynamic>{};
    final _result = await _dio.request('user_credit_actions',
        queryParameters: queryParameters,
        options: RequestOptions(
            method: 'POST',
            headers: <String, dynamic>{},
  ...
  Future<List<ProductModel>> getRedemptionProdcuts() async {
    ...
    final queryParameters = <String, dynamic>{};
    final _data = <String, dynamic>{};
    final _result = await _dio.request<List<dynamic>>('redemption_products',
        queryParameters: queryParameters,
        options: RequestOptions(
            method: 'GET',
            headers: <String, dynamic>{},
